...
{
	$result = mysqli_query($conn,"INSERT INTO stock( email, field_1, field_2, field_3, field_4,
							field_5, field_6, field_7, field_8,field_9,field_10,field_11,
							field_12,created_date	)
